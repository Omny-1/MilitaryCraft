...
import me.bibo.militarycraft.vehicles.jet.commands.JetCommand;
import me.bibo.militarycraft.vehicles.jet.jet.JetManager;
import me.bibo.militarycraft.vehicles.jet.listeners.DamageListener;
import me.bibo.militarycraft.vehicles.jet.listeners.InteractionListener;
import me.bibo.militarycraft.vehicles.jet.listeners.PlacementListener;
import me.bibo.militarycraft.vehicles.jet.listeners.WorldListener;
...
public final class JetModule implements MilitaryModule {

    private Core core;
    private JetRuntime runtime;
    private JetManager manager;
    private VehicleProvider provider;
    private JetCommand commands;
    ...
    public void enable(Core core) {
        ...
        runtime = new JetRuntime(core);
        manager = runtime.jets();
        ...
        commands = new JetCommand(runtime);
        core.commands().register(id(), commands.all());
        PluginCommand direct = core.plugin().getCommand("jet");
        if (direct != null) {
        ...
        core.logger().info("JetCraft enabled. Max jet HP = " + runtime.config().maxHealth
