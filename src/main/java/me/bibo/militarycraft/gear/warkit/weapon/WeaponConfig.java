...
public final class WeaponConfig {
    ...
    public WeaponConfig(ConfigurationSection c) {
        ...
        rifleRange = c.getDouble("weapons.rifle.range", 50.0);
        ...
        pistolRange = c.getDouble("weapons.pistol.range", 30.0);
        ...
        patriotLockRange = c.getDouble("weapons.patriot.lock-range", 60.0);
        ...
        fragRadius = c.getDouble("weapons.frag-grenade.radius", 4.0);
        ...
        smokeRadius = c.getDouble("weapons.smoke-grenade.radius", 6.0);
        smokeThrowSpeed = c.getDouble("weapons.smoke-grenade.throw-speed", 1.2);

        flashRadius = c.getDouble("weapons.flash-grenade.radius", 16.0);
        ...
        impulseRadius = c.getDouble("weapons.impulse-grenade.radius", 4.5);
        ...
        flameRange = c.getDouble("weapons.flamethrower.range", 5.0);
        ...
        maximRange = c.getDouble("weapons.maxim.range", 60.0);
        ...
        barbedRadius = c.getDouble("weapons.barbed-wire.radius", 1.6);
        ...
        gasRadius = c.getDouble("weapons.sleep-gas.radius", 4.5);
        ...
        hookRange = c.getDouble("weapons.grappling-hook.range", 30.0);
        ...
        mineTriggerRadius = c.getDouble("weapons.proximity-mine.trigger-radius", 2.2);
        ...
        sentryRange = c.getDouble("weapons.sentry-gun.range", 24.0);
